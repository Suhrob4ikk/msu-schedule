...
# Список настоящих аудиторий — используется и при чистке БД (main.py:seed_rooms),
# и при подсчёте свободных аудиторий (api/routes/schedule.py), поэтому лежит
# здесь, а не в main.py: оба места импортируют модели, но не друг друга.
CANONICAL_ROOMS = [
